  ...
  useEffect(() => {
    ...
    socket.current.on("connect", () => {
      socket.current.on("roomNotice", (userName) => {
        console.log(`${userName} join to the group!`);
      });
          ...
          <div className="bg-white rounded-xl shadow-lg max-w-md p-6">
            ...
            <form onSubmit={handleNameSubmit} className="mt-4">
              <input
                ...
                className="full border border-gray-200 rounded-md px-3 py-2 outline-green-500 placeholder-gray-400"
      ...
      {!showNamePopup && (
        <div className="w-full max-w-2xl h-[90vh] bg-white rounded-xl shadow-md flex flex-col overflow-hidden">
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
            <div className="h-10 w-10 rounded-full bg-[#075254] flex items-center justify-center text-white font-semibold">
            ...
            <div className="text-sm font-medium text-[#303030] capitalize rounded-full border border-[#303030] px-4 py-2">
              <span className="font-medium text-[#303030]">{userName}</span>
            </div>
          </div>
                ...
                >
                  <div
                    className={`max-w-[78%] p-3 my-2 rounded-[18px] text-sm leading-5 shadow-sm ${
                      mine
                        ? "bg-[#06C86D] text-[#303030] rounded-br-2xl"
